...
class NativeObjectReference:
    ...
    The public ABI exposes host IDs only for host-owned objects. PortaPy-created
    classes and instances therefore remain opaque when read through the Python
    binary facade rather than being misidentified as host objects.
    """
