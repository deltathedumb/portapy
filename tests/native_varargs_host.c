...
int main(int argc, char **argv) {
    ...
    const char source[] =
        ...
        "    return summarize(value, rest[0], rest[-1])\n"
        "empty = summarize()\n"
    ...
    if (!evaluate_i64(eval_utf8, as_i64, release, runtime, "defaulted", 12)) return 16;
    if (!evaluate_i64(eval_utf8, as_i64, release, runtime, "positional", 24)) return 17;
    if (!evaluate_i64(eval_utf8, as_i64, release, runtime, "mixed", 48)) return 18;
    if (!evaluate_i64(eval_utf8, as_i64, release, runtime, "keyword_middle", 42)) return 19;
    if (!evaluate_i64(eval_utf8, as_i64, release, runtime, "nested", 41)) return 20;
    if (!evaluate_i64(eval_utf8, as_i64, release, runtime, "values", 100)) return 21;
    if (!evaluate_status(eval_utf8, runtime, "summarize(values=1)", PORTAPY_TYPE_ERROR)) return 22;
