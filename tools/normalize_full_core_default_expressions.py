...
# The parser is generated by ``normalize_full_core_native_parser``. During hosted
# unit tests that exercise the native-AST bridge in isolation this file does not
# exist yet, so the repair is deliberately deferred until the full pipeline has
# vendored the parser runtime.
...
def main() -> int:
    if not PATH.exists():
        print("DEFERRED NATIVE DEFAULT EXPRESSIONS")
        return 0
