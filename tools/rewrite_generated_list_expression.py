"""Teach generated boolean expressions about native lists."""
...
def _truthy() -> str:
    ...
    if kind == 10:
        return [1 if _scalar_list_size_unchecked(value) != 0 else 0, PORTAPY_OK]
    return [1, PORTAPY_OK]'''


def rewrite_generated_list_expression(path: Path) -> Path:
...
__all__ = ["rewrite_generated_list_expression"]
