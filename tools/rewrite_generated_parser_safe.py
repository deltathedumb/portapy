...
from tools.rewrite_generated_list import rewrite_generated_list
from tools.rewrite_generated_list_expression import rewrite_generated_list_expression
...
def rewrite_generated_scalar(path: Path) -> Path:
    """Apply scalar rewrites and native tuple/dictionary/list semantics."""
...
def rewrite_generated_expression(path: Path) -> Path:
    ...
    rewrite_generated_list_expression(path)
    return path
